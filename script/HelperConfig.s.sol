...
contract HelperConfig is Script {
        ...
        returns (NetworkConfig memory anvilNetworkConfig)
    {
        ...
        vm.startBroadcast();
        MockV3Aggregator mockWethUsdPriceFeed = new MockV3Aggregator(
            DECIMALS,
            ETH_USD_PRICE
        );
        ...
        MockV3Aggregator mockWbtcUsdPriceFeed = new MockV3Aggregator(
            DECIMALS,
            BTC_USD_PRICE
        );
        ...
        anvilNetworkConfig = NetworkConfig({
            wethUsdPriceFeed: address(mockWethUsdPriceFeed), // ETH / USD
            weth: address(weth),
